			...
			<div class="container">
				<div class="signup-content">
					<div class="signup-form">
						...
						<form method="post" action="AddUserServlet" class="register-form"
							id="register-form">
							...
							<div class="form-group form-button">
								<input type="submit" name="signup" id="signup"
									class="form-submit" value="Add User" />
							</div>
						</form>
					</div>
					<div class="signup-image">
						...
						<a href="admin.jsp" class="signup-image-link">Back To Admin DashBoard
							</a>
					</div>
				</div>
			</div>
