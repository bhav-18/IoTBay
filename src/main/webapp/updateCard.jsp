				...
				<div class="card-item" v-bind:class="{ '-active' : isCardFlipped }">
					<div class="card-item__side -front">
						...
						<div class="card-item__cover">
							<img v-bind:src="'./images/' + currentCardBackground + '.jpg'"
								class="card-item__bg">
						</div>
						...
						<div class="card-item__wrapper">
							<div class="card-item__top">
								...
								<div class="card-item__type">
									<transition name="slide-fade-up"> <img
										v-bind:src="'./images/' + getCardType + '.png'"
							...
							<div class="card-item__content">
								...
								<div class="card-item__date" ref="cardDate">
									...
									</label> / <label for="cardYear" class="card-item__dateItem"> <transition
											name="slide-fade-up"> <span v-if="cardYear"
					...
					<div class="card-item__side -back">
						...
						<div class="card-item__cvv">
							...
							<div class="card-item__type">
								<img v-bind:src="'./images/' + getCardType + '.png'"
			...
			<form id="updateForm" action="UpdateCardServlet" method="post"
				...
				<div class="card-input">
					<label for="cardNumber" class="card-input__label">Card
						...
						class="card-input__input" v-mask="generateCardNumberMask"
				...
				<div class="card-input">
					<label for="cardName" class="card-input__label">Card
						Holders</label> <input type="text" id="cardName" class="card-input__input"
