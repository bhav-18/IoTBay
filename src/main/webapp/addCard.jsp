  ...
  <div class="wrapper" id="app">
    <div class="card-form">
      <div class="card-list">
        <div class="card-item" v-bind:class="{ '-active' : isCardFlipped }">
          <div class="card-item__side -front">
            ...
            <div class="card-item__cover">
              <img v-bind:src="'./images/' + currentCardBackground + '.jpg'" class="card-item__bg">
            </div>
              ...
              <div class="card-item__top">
                ...
                <div class="card-item__type">
                  <transition name="slide-fade-up">
                    <img v-bind:src="'./images/' + getCardType + '.png'" v-if="getCardType" v-bind:key="getCardType"
          ...
          <div class="card-item__side -back">
            ...
            <div class="card-item__cvv">
              <div class="card-item__cvvTitle">CVC/CVV</div>
       ...
       <div action="SaveCardServlet" method="post" class="card-form__inner">
        ...
        <div class="card-form__row">
          ...
          <div class="card-form__col -cvv">
            <div class="card-input">
              <label for="cardCvv" class="card-input__label">CVC/CVV</label>
        ...
        <button type="submit" class="card-form__button card-form__button--submit" onclick="return validateForm()">
        Submit
        </button>
        <button class="card-form__button card-form__button--cancel" onclick="window.location.href='payment.jsp'">
        Cancel
        </button> 
      </div>
    </div>
